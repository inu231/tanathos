			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span> Editar Categoria de Posts </h2>
						<div class="box-icon">
					...
					<div class="box-content">
							  {!! Form::model($postCategory, array('method' => 'put', 'class' => 'form-admin', 'url' => '/admin/post-categories/update/' . $postCategory->id, 'id' => 'EdittagForm')) !!}
						  <fieldset>
