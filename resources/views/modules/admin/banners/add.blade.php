			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span> Adicionar banner </h2>
						<div class="box-icon">
					...
					<div class="box-content">
							<?=Form::open(array('url' => '/admin/banners/store', 'id' => 'AddbannerForm', 'class' => 'form-admin', 'files' => true)); ?>
						  <fieldset>
